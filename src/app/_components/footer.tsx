      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-6 py-12 lg:grid-cols-[minmax(0,1fr)_auto] lg:px-10">
        <div>
          ...
          <h2 className="mt-3 text-2xl font-semibold tracking-[-0.03em] text-slate-950">
            A modern Microsoft identity journal for practitioners and security leaders.
          </h2>
        ...
        <div className="grid gap-3 text-sm text-slate-600 lg:justify-items-end">
          ...
          <Link href="mailto:hello@sentinelidentity.blog" className="transition hover:text-slate-950">
            hello@sentinelidentity.blog
          </Link>
